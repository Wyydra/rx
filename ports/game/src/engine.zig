...
pub const Engine = struct {
    ...
    scene: Scene = .{},
    id_map: std.AutoHashMap(u64, usize),
    ...
    pub fn init(allocator: std.mem.Allocator, sched: *rx.rx_scheduler_t) !*Engine {
        ...
        self.* = .{
            ...
            .mutex = null,
            .scene = .{},
            .id_map = std.AutoHashMap(u64, usize).init(allocator),
    ...
    pub fn getEntityIndex(self: *Engine, id: u64) ?usize {
        return self.id_map.get(id);
    }

    pub fn removeEntity(self: *Engine, id: u64) void {
